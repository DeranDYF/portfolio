        ...
        <section>
            <div className="grid grid-cols-1 lg:grid-cols-12">
                <div className="col-span-7">
                    <h1 className="text-white mb-4 mt-4 text-4xl lg:text-6xl font-extrabold">
                    ...
                    <h3 className="text-4xl lg:text-6xl font-extrabold mb-4"><TypeAnimation
                        ...
                        repeat={Infinity}
                    /></h3>
                    <p className="text-[#ADB7BE] text-sm lg:text-lg">Graduated majoring in informatics engineering. Have the ability as a Fullstack Developer with several programming languages to build and develop company applications. Has helped design, build, and develop several applications to improve company efficiency and management.</p>
                    <div className="mt-4">
