...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col bg-[#121212]">
      ...
      <div className="mx-10 rounded-lg px-12 lg:px-20 py-4 mt-5 lg:mt-20 bg-[#181818]" id="experience">
      <AboutSection/>
      </div>
      ...
      <div className="mx-10 rounded-lg py-4 text-center lg:text-start mb-3 lg:mb-6 mt-5 lg:mt-20 bg-[#181818]" id="contact">
      <ContactSection/>
      </div>
